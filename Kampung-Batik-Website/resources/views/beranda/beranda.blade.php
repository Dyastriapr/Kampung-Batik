...
<html lang="en">
  ...
  <body class="">
    <header class="">
        @include('partials.beranda.navbar-beranda')
          ...
          <div class="col-md-6">
            <div class="card text-center rounded-0  shadow">
              ...
              <div class="card-body">
                ...
                <a href="/api/toko" class="btn btn-success">Detail</a>
              </div>
            </div>
          </div>
          {{-- kunjungan Wisata --}}
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 mb-5 ">
      <div class="col ">
        <div class="card h-100 align-items-center shadow rounded-0">
          <img src="/img/icon/instagram_1077042.png" class="card-img-top mt-4" style="width: 38px" alt="...">
          <div class="card-body">
            <p class="card-text">kampungcibuluh</p>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100 align-items-center shadow rounded-0">
          <img src="\img\icon\facebook_739237.png" class="card-img-top mt-4" style="width: 38px" alt="...">
          <div class="card-body">
            <p class="card-text">Kampung Batik Cibuluh Official</p>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100 align-items-center shadow rounded-0">
          <img src="\img\icon\youtube_665232.png" class="card-img-top mt-4" style="width: 38px" alt="...">
          <div class="card-body">
            <p class="card-text">Kampung Cibuluh</p>
          </div>
        </div>
      </div>
    </div>
